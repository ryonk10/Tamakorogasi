...
public class Level1Activity extends AppCompatActivity {
    ...
    private BallSurfaceViewLevel1 bsvLevel1;
    private Handler hd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SurfaceView svLevel1 = (SurfaceView) findViewById(R.id.surfaceView);
        bsvLevel1 = new BallSurfaceViewLevel1(svLevel1);
    ...
    class CheckConditionHandler implements Handler.Callback{
        ...
        public boolean handleMessage(@NonNull Message message) {
            ...
            if(condition=="GameOver"){
                DialogFragment gameOverFragment = new GameOverWindowFragment(1);
    ...
    class BallSurfaceViewLevel1 implements View.OnTouchListener, SurfaceHolder.Callback, Runnable {
        ...
        BallSurfaceViewLevel1(SurfaceView svLevel1) {
            holder = svLevel1.getHolder();
            holder.addCallback(this);
            svLevel1.setOnTouchListener(this);
        ...
        public void run() {
            ...
            int[][] boxWall = {
                    ...
                    {0, screen_height / 2, screen_width / 2, screen_height / 2 + boxHeight},
                    {screen_width / 2, 0, screen_width, boxHeight},
                    {0, -screen_height / 3, screen_width * 3 / 4, -screen_height / 3 + boxHeight},
                    {screen_width / 2, -screen_height * 2, screen_width / 2 + boxHeight, -screen_height / 2},
                    {screen_width / 4, -screen_height, screen_width * 3 / 4, -screen_height + boxHeight},
                    {screen_width / 2, -screen_height * 2 + 200, screen_width, -screen_height * 2 + 200 + boxHeight},
                    //ゴール
